...
Sometimes called “smart” or “stateful” they tend to implement logic and state.

- [x] Name three lifecycle methods and their purposes.

componentDidMount = This method is a good place to set up any subscriptions. Also can setState.

componentDidUpdate = To operate on the DOM when the component has been updated.

componentWillUnmount = Perform any necessary cleanup in this method, such as invalidating timers, canceling network requests, or cleaning up any subscriptions that were created in componentDidMount().
